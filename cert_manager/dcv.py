...
class DomainControlValidation(Endpoint):
    """Query the Sectigo Cert Manager REST API for Domain Control Validation data."""
    ...
    def __init__(self, client, api_version="v1"):
        ...
        """
        super(DomainControlValidation, self).__init__(client=client, endpoint="/dcv", api_version=api_version)
    ...
    def status(self, domain):
        ...
        url = self._url("api/dcv/v1/validation/%s" % domain)
